...
.EXAMPLE
    .\Autopilot-Cleanup-AppAuth.ps1 -TenantId "your-tenant-id" -AppId "your-app-id" -ClientSecret "your-secret"

.EXAMPLE
    .\Autopilot-Cleanup-AppAuth.ps1 -WhatIf
...
function Connect-ToGraphAppAuth {
    ...
    try {
        ...
        Write-ColorOutput "✓ Successfully connected to Microsoft Graph (App-Only)" "Green"
        return $true
    }
    catch {
